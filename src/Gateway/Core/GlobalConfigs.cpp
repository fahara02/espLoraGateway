...
{
Config::Config() :
	_prefs(NULL), _tcpPort(80), _modbusPort(502), _tcpTimeout(10000), _modbusBaudRate(9600),
	_modbusConfig(SERIAL_8N1), _modbusRtsPin(-1), _serialBaudRate(115200), _serialConfig(SERIAL_8N1)
{
}
void Config::begin(Preferences* prefs)
{
	...
	_modbusPort = _prefs->getUShort("modbusPort", _modbusPort);
